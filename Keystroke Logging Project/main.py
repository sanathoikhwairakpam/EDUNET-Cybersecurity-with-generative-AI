...
class KeyloggerApp:
    def __init__(self, root):
        ...
        # Colors
        self.bg_color = "#f0f4f8"  # Very light blue/white
        self.accent_color = "#3b82f6"  # Bright blue
        self.text_color = "#1e293b"  # Dark blue/grey
        self.success_color = "#10b981"  # Green
        self.stop_color = "#ef4444"  # Red
        self.white = "#ffffff"
    ...
    def setup_ui(self):
        ...
        self.action_button = tk.Button(main_frame, text="Start Recording", font=("Segoe UI", 11, "bold"),
                                       bg=self.accent_color, fg=self.white, activebackground="#2563eb", activeforeground=self.white,
                                       relief="flat", cursor="hand2", command=self.toggle_logging, height=2)
        self.action_button.pack(fill="x", pady=10)

        # Footer
        footer_label = tk.Label(main_frame, text="Logs saved locally", font=("Segoe UI", 8), 
                                bg=self.bg_color, fg="#94a3b8")
